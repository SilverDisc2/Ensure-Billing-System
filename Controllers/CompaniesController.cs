...

{
...

    {
        ...
        public ActionResult Create([Bind(Include = "userID,OwnerName,CompanyName,Type,Phone,Email,Password,Address,City,ZIPCode")] Company company)
        {
        ...
        [HttpPost]
        public ActionResult Login(Company login)
        {
            if (ModelState.IsValid)
            {
                EBSEntities db = new EBSEntities();

                var user = (from userlist in db.Companies
